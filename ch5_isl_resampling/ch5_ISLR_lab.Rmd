---
title: "Lab: Resampling Methods Ch5 ISLR"
...
This is an edited version of the ISLR labs replicated in tidymodels available from https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/resampling-methods.html
by, "ISLR tidymodels Labs" was written by Emil Hvitfeldt. 
...
data(Auto, package = "ISLR")
Auto <- as_tibble(Auto)
fits_lm <- lm(mpg~horsepower, data=Auto)
# Get regression table:
summary(fits_lm)
