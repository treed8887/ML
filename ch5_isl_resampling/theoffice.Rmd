...
Use `theoffice` data from the [**schrute**](https://bradlindblad.github.io/schrute/) package to predict IMDB scores for episodes of The Office. Note: The episodes listed in `theoffice` don't match the ones listed in the data we used in the [cross validation lesson](https://laurark.github.io/sta323content/slides/u3-d09-cross-validation/u3-d09-cross-validation.html).
...
Note: The episodes listed in `theoffice` don't match the ones listed in the data we used in the [cross validation lesson](https://laurark.github.io/sta323content/slides/u3-d09-cross-validation/u3-d09-cross-validation.html).
